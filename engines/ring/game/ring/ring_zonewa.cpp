...
void ZoneWARing::onInit() {
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 0, kPuzzle51001, "TR_WA_A06", kImageTypeBMP, Common::Point(262, 151), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 1, kPuzzle51002, "TR_WA_A09", kImageTypeBMP, Common::Point(139, 94), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 2, kPuzzle51004, "TR_WA_BS", kImageTypeBMP, Common::Point(264, 189), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 3, kPuzzle51007, "TR_WA_ES", kImageTypeBMP, Common::Point(218, 18), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 4, kPuzzle51009, "TR_WA_GS", kImageTypeBMP, Common::Point(228, 82), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 5, kPuzzle51011, "TR_WA_IS", kImageTypeBMP, Common::Point(323, 184), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 6, kPuzzle51012, "TR_WA_JS", kImageTypeBMP, Common::Point(223, 16), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAddPresentation(kObject51000);
	_app->objectPresentationAddAnimationToPuzzle(kObject51000, 7, kPuzzle51013, "TR_WA_KS", kImageTypeBMP, Common::Point(210, 70), kDrawTypeNormal, 1000, 19, 12.5f, 4);
	_app->objectAdd(kObjectMagicLance, "Beam of light", "WA_Lance", 1);
	_app->objectAddBagAnimation(kObjectMagicLance, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectFeather, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectDeadLeaf, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectInk, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectPaper, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectStylet, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectInkedStylet, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObject50100, 0, kPuzzle50100, "WAS01N08P01L01_A.bmp", Common::Point(450, 401), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 1, kPuzzle50100, "WAS01N08P01L01_B.bmp", Common::Point(490, 388), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 2, kPuzzle50100, "WAS01N08P01L01_C.bmp", Common::Point(526, 414), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 3, kPuzzle50100, "WAS01N08P01L03.bmp", Common::Point(221, 397), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 4, kPuzzle50100, "WAS01N08P01L02.bmp", Common::Point(326, 401), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 5, kPuzzle50100, "WAS01N08P01L05.bmp", Common::Point(218, 398), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 6, kPuzzle50100, "WAS01N08P01L04.bmp", Common::Point(325, 400), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddAnimationToPuzzle(kObject50100, 7, kPuzzle50100, "WAS01N08P01S01", kImageTypeBMP, Common::Point(270, 101), kDrawTypeNormal, 1000, 50, 12.5f, 6);
	...
	_app->objectAddPresentation(kObject50100);
	_app->objectPresentationAddAnimationToPuzzle(kObject50100, 8, kPuzzle50100, "WAS01N08P01S02", kImageTypeBMP, Common::Point(316, 30), kDrawTypeNormal, 1000, 50, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject50100, 8, 0, 50004);
	_app->objectPresentationAddImageToPuzzle(kObject50100, 8, kPuzzle50100, "WAS01N08P01S01.bmp", Common::Point(270, 101), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject50600, 0, kPuzzle50601, "WAS06N01P01S01", kImageTypeBMP, Common::Point(171, 182), kDrawTypeNormal, 1000, 50, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject50600, 0, 0, 50001);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddAnimationToPuzzle(kObject50600, 1, kPuzzle50602, "WAS06N01P02S01", kImageTypeBMP, Common::Point(77, 134), kDrawTypeNormal, 1000, 30, 12.5f, 4);
	_app->objectPresentationSetAnimationOnPuzzle(kObject50600, 1, 0, 50002);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 2, kPuzzle50601, "WAS06N01P01L01.bmp", Common::Point(206, 149), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 3, kPuzzle50601, "WAS06N01P01L02.bmp", Common::Point(383, 146), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 4, kPuzzle50601, "WAS06N01P01L03.bmp", Common::Point(225, 282), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 5, kPuzzle50601, "WAS06N01P01L04.bmp", Common::Point(380, 294), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 6, kPuzzle50602, "WAS06N01P02L01.bmp", Common::Point(115, 178), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject50600);
	_app->objectPresentationAddImageToPuzzle(kObject50600, 7, kPuzzle50602, "WAS06N01P02L02.bmp", Common::Point(114, 158), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject50001, 0, kPuzzle50002, "WAS00N01P01S01", kImageTypeBMP, Common::Point(414, 63), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject50001);
	_app->objectPresentationAddAnimationToPuzzle(kObject50001, 1, kPuzzle50001, "WAS00N01P01S02", kImageTypeBMP, Common::Point(256, 263), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAdd(kObjectGolem1, "Golem", "FO_Golem", 1);
	_app->objectAddBagAnimation(kObjectGolem1, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddPresentation(kObjectGolem1);
	_app->objectPresentationAddImageToPuzzle(kObjectGolem1, 1, kPuzzle50400, "WAS04N02P01L02.bmp", Common::Point(212, 178), true, kDrawTypeNormal, 998);
	_app->objectAdd(kObjectFronthead, "Head front", "WA_GolemHeadF", 8);
	_app->objectAddBagAnimation(kObjectFronthead, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectFronthead, 0, kPuzzle50400, "WAS04N02P01L09.bmp", Common::Point(296, 160), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectFronthead);
	_app->objectPresentationAddImageToPuzzle(kObjectFronthead, 1, kPuzzle50400, "WAS04N02P01L03.bmp", Common::Point(209, 87), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectBackhead, "Head back", "WA_GolemHeadB", 8);
	_app->objectAddBagAnimation(kObjectBackhead, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectBackhead, 0, kPuzzle50400, "WAS04N02P01L21.bmp", Common::Point(301, 157), true, kDrawTypeNormal, 999);
	_app->objectAddPresentation(kObjectBackhead);
	_app->objectPresentationAddImageToPuzzle(kObjectBackhead, 1, kPuzzle50400, "WAS04N02P01L06.bmp", Common::Point(403, 89), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectBelly, "Belly", "WA_GolemStomak", 8);
	_app->objectAddBagAnimation(kObjectBelly, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectBelly, 0, kPuzzle50400, "WAS04N02P01L13.bmp", Common::Point(292, 252), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectBelly, 0, kPuzzle50400, "WAS04N02P01L14.bmp", Common::Point(302, 293), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectBelly);
	_app->objectPresentationAddImageToPuzzle(kObjectBelly, 1, kPuzzle50400, "WAS04N02P01L07.bmp", Common::Point(142, 302), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectRightArm, "Arm right", "WA_GolemArmR", 8);
	_app->objectAddBagAnimation(kObjectRightArm, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectRightArm, 0, kPuzzle50400, "WAS04N02P01L10.bmp", Common::Point(224, 203), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectRightArm);
	_app->objectPresentationAddImageToPuzzle(kObjectRightArm, 1, kPuzzle50400, "WAS04N02P01L04.bmp", Common::Point(147, 206), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectLeftArm, "Arm left", "WA_GolemArmL", 8);
	_app->objectAddBagAnimation(kObjectLeftArm, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectLeftArm, 0, kPuzzle50400, "WAS04N02P01L11.bmp", Common::Point(375, 210), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectLeftArm);
	_app->objectPresentationAddImageToPuzzle(kObjectLeftArm, 1, kPuzzle50400, "WAS04N02P01L05.bmp", Common::Point(440, 208), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectLegs, "Legs", "WA_GolemLeg", 8);
	_app->objectAddBagAnimation(kObjectLegs, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L15.bmp", Common::Point(269, 282), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L16.bmp", Common::Point(268, 299), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L17.bmp", Common::Point(263, 307), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L18.bmp", Common::Point(365, 285), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L19.bmp", Common::Point(348, 301), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 0, kPuzzle50400, "WAS04N02P01L20.bmp", Common::Point(334, 309), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectLegs);
	_app->objectPresentationAddImageToPuzzle(kObjectLegs, 1, kPuzzle50400, "WAS04N02P01L08.bmp", Common::Point(440, 301), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectHeart, "Heart", "WA_GolemHeart", 8);
	_app->objectAddBagAnimation(kObjectHeart, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectHeart, 0, kPuzzle50400, "WAS04N02P01L12.bmp", Common::Point(343, 231), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectHeart);
	_app->objectPresentationAddImageToPuzzle(kObjectHeart, 1, kPuzzle50400, "WAS04N02P01L22.bmp", Common::Point(315, 74), true, kDrawTypeNormal, 1000);
	...
	for (uint32 i = 0; i < 7; i++) {
		...
		_app->objectPresentationAddImageToPuzzle((ObjectId)(kObject50451 + i), 0, kPuzzle50401, Common::String::format("WAS04N02P02_L%d.tga", i + 1), Common::Point(125, val), true, kDrawTypeAlpha, 1000);
	...
	_app->objectAddBagAnimation(kObjectThread, kImageTypeTGA, kDrawTypeAlpha, 1, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectTree, 1, kPuzzle50501, "WAS05N02P01L01.BMP", Common::Point(281, 164), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectTree);
	_app->objectPresentationAddImageToRotation(kObjectTree, 2, 50502, 2);
	_app->objectPresentationAddImageToPuzzle(kObjectTree, 2, kPuzzle50502, "WAS05N02P02L01.BMP", Common::Point(226, 189), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectTree);
	_app->objectPresentationAddImageToRotation(kObjectTree, 3, 50502, 3);
	_app->objectPresentationAddImageToPuzzle(kObjectTree, 3, kPuzzle50503, "WAS05N02P03L01.BMP", Common::Point(215, 200), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectTree);
	_app->objectPresentationAddImageToRotation(kObjectTree, 4, 50502, 4);
	_app->objectPresentationAddImageToPuzzle(kObjectTree, 4, kPuzzle50504, "WAS05N02P04L01.BMP", Common::Point(213, 140), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObjectTree);
	...
	_app->objectAddPresentation(kObject50700);
	_app->objectPresentationAddAnimationToPuzzle(kObject50700, 2, kPuzzle50701, "WAS07N01P01S01", kImageTypeBMP, Common::Point(293, 187), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject50700);
	_app->objectPresentationAddAnimationToPuzzle(kObject50700, 3, kPuzzle50702, "WAS07N01P01S02", kImageTypeBMP, Common::Point(304, 65), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAdd(kObjectCounch1, "Conch", "WA_Conch", 1);
	_app->objectAddBagAnimation(kObjectCounch1, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectBark, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectFlower, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectDragonSword, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddBagAnimation(kObjectApple, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
