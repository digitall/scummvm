...
void ZoneN2Ring::onInit() {
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 0, kPuzzle72001, "TR_AS_RO_BS", kImageTypeBMP, Common::Point(375, 203), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 1, kPuzzle72002, "TR_AS_RO_CS", kImageTypeBMP, Common::Point(281, 154), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 2, kPuzzle72003, "TR_AS_RO_DS", kImageTypeBMP, Common::Point(284, 163), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 3, kPuzzle72004, "TR_AS_RO_ES", kImageTypeBMP, Common::Point(147, 140), kDrawTypeNormal, 1000, 23, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 4, kPuzzle72005, "TR_AS_RO_FS", kImageTypeBMP, Common::Point(388, 244), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 5, kPuzzle72006, "TR_AS_RO_HS", kImageTypeBMP, Common::Point(146, 156), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 6, kPuzzle72007, "TR_AS_RO_IS", kImageTypeBMP, Common::Point(308, 221), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 7, kPuzzle72008, "TR_AS_RO_JS", kImageTypeBMP, Common::Point(250, 102), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 8, kPuzzle72009, "TR_AS_RO_KS", kImageTypeBMP, Common::Point(224, 262), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject72000);
	_app->objectPresentationAddAnimationToPuzzle(kObject72000, 9, kPuzzle72010, "TR_AS_RO_MS", kImageTypeBMP, Common::Point(173, 127), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAdd(kObject70001, "Alberich", "", 1);
	_app->objectAddPresentation(kObject70001);
	_app->objectPresentationAddAnimationToPuzzle(kObject70001, 0, kPuzzle70000, "N2EXTRA_1B", kImageTypeBMP, Common::Point(1, 153), kDrawTypeNormal, 1000, 53, 10.0f, 4);
	_app->objectAddPresentation(kObject70001);
	_app->objectPresentationAddAnimationToPuzzle(kObject70001, 1, kPuzzle70000, "N2EXTRA_2B", kImageTypeBMP, Common::Point(0, 16), kDrawTypeNormal, 1000, 37, 10.0f, 4);
	_app->objectAddPresentation(kObject70001);
	_app->objectPresentationAddAnimationToPuzzle(kObject70001, 2, kPuzzle70000, "N2EXTRA_3B", kImageTypeBMP, Common::Point(49, 38), kDrawTypeNormal, 1000, 53, 10.0f, 4);
	_app->objectAddPresentation(kObject70001);
	...
	_app->objectAddBagAnimation(kObjectFire, kImageTypeTGA, kDrawTypeAlpha, 13, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObject70100, 0, kPuzzle70100, "N2S01N01P01L01.0001.bmp", Common::Point(101, 68), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70100);
	_app->objectPresentationAddImageToPuzzle(kObject70100, 1, kPuzzle70100, "N2S01N01P01L02.0001.bmp", Common::Point(80, 63), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70100);
	_app->objectPresentationAddImageToPuzzle(kObject70100, 2, kPuzzle70100, "N2S01N01P01L03.0001.bmp", Common::Point(116, 159), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject70101, 0, kPuzzle70100, "N2S01N01P01S03.0001.bmp", Common::Point(361, 259), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70101);
	_app->objectPresentationAddAnimationToPuzzle(kObject70101, 1, kPuzzle70100, "N2S01N01P01S01", kImageTypeBMP, Common::Point(85, 68), kDrawTypeNormal, 1000, 36, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70101, 1, 0, 70101);
	_app->objectAddPresentation(kObject70101);
	_app->objectPresentationAddAnimationToPuzzle(kObject70101, 2, kPuzzle70100, "N2S01N01P01L02S01", kImageTypeBMP, Common::Point(80, 63), kDrawTypeNormal, 1000, 36, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70101, 2, 0, 70103);
	_app->objectAddPresentation(kObject70101);
	_app->objectPresentationAddAnimationToPuzzle(kObject70101, 3, kPuzzle70100, "N2S01N01P01S01", kImageTypeBMP, Common::Point(85, 68), kDrawTypeNormal, 1000, 36, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70101, 3, 0, 70100);
	_app->objectAddPresentation(kObject70101);
	_app->objectPresentationAddAnimationToPuzzle(kObject70101, 4, kPuzzle70100, "N2S01N01P01L02S01", kImageTypeBMP, Common::Point(80, 63), kDrawTypeNormal, 1000, 36, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70101, 4, 0, 70102);
	_app->objectAddPresentation(kObject70101);
	_app->objectPresentationAddImageToPuzzle(kObject70101, 5, kPuzzle70100, "N2S01N01P01S03.0003.bmp", Common::Point(361, 259), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70101);
	...
	_app->objectPresentationAddImageToPuzzle(kObject70102, 0, kPuzzle70100, "N2S01N01P01S03.0004.bmp", Common::Point(385, 299), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70102);
	_app->objectPresentationAddAnimationToPuzzle(kObject70102, 1, kPuzzle70100, "N2S01N01P01S02", kImageTypeBMP, Common::Point(40, 65), kDrawTypeNormal, 1000, 46, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70102, 1, 0, 70105);
	_app->objectAddPresentation(kObject70102);
	_app->objectPresentationAddAnimationToPuzzle(kObject70102, 2, kPuzzle70100, "N2S01N01P01S02", kImageTypeBMP, Common::Point(40, 65), kDrawTypeNormal, 1000, 23, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70102, 2, 0, 70104);
	_app->objectAddPresentation(kObject70102);
	_app->objectPresentationAddAnimationToPuzzle(kObject70102, 3, kPuzzle70100, "N2S01N01P01S02", kImageTypeBMP, Common::Point(40, 65), kDrawTypeNormal, 1000, 23, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70102, 3, 0, 70106);
	_app->objectAddPresentation(kObject70102);
	_app->objectPresentationAddImageToPuzzle(kObject70102, 4, kPuzzle70100, "N2S01N01P01S03.0002.bmp", Common::Point(385, 299), true, kDrawTypeNormal, 1000);
	...
	for (uint32 i = 0; i < 14; i++) {
		...
		_app->objectPresentationAddImageToPuzzle(kObject70103, i, kPuzzle70100, Common::String::format("N2S01N01P02S01.%04d.bmp", i + 1), Common::Point(504, 194), true, kDrawTypeNormal, 1000);
	}
	...
	for (uint32 i = 0; i < 20; i++) {
		...
		_app->objectPresentationAddImageToPuzzle(kObject70106, i, kPuzzle70102, Common::String::format("N2S01N01P03L01S01.%04d.bmp", i + 1), Common::Point(213, 254), true, kDrawTypeNormal, 1000);
	}
	...
	for (uint32 i = 0; i < 15; i++) {
		...
		_app->objectPresentationAddImageToPuzzle(kObject70108, i, kPuzzle70102, Common::String::format("N2S01N01P03L01S03.%04d.bmp", i + 1), Common::Point(390, 271), true, kDrawTypeNormal, 999);
	}

	_app->objectAddPresentation(kObject70108);
	_app->objectPresentationAddImageToPuzzle(kObject70108, 14, kPuzzle70102, "N2S01N01P03L01S03A.bmp", Common::Point(340, 237), true, kDrawTypeNormal, 1000);
	_app->objectPresentationAddImageToPuzzle(kObject70108, 14, kPuzzle70102, "N2S01N01P03L01S03B.bmp", Common::Point(311, 179), true, kDrawTypeNormal, 1000);
	_app->objectAdd(kObjectLogeTear3, "Loge's Tear", "NI_Tear", 1);
	_app->objectAddBagAnimation(kObjectLogeTear3, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 1, kPuzzle70300, "N2S03N01P01S01", kImageTypeBMP, Common::Point(260, 73), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 2, kPuzzle70301, "N2S03N01P01S02", kImageTypeBMP, Common::Point(289, 79), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 3, kPuzzle70302, "N2S03N01P01S04", kImageTypeBMP, Common::Point(305, 117), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 4, kPuzzle70303, "N2S02N01P02S02", kImageTypeBMP, Common::Point(311, 166), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 5, kPuzzle70304, "N2S02N01P02S03", kImageTypeBMP, Common::Point(97, 185), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70300);
	_app->objectAddPresentation(kObject70300);
	_app->objectPresentationAddAnimationToPuzzle(kObject70300, 7, kPuzzle70306, "N2S03N01P01S03", kImageTypeBMP, Common::Point(270, 135), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAdd(kObjectCage, "Cage", "N2_Cage", 1);
	_app->objectAddBagAnimation(kObjectCage, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObject70404, 0, kPuzzle70411, "N2S04N03P03L01.0001.bmp", Common::Point(214, 173), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddImageToPuzzle(kObject70404, 1, kPuzzle70411, "N2S04N03P03L02.0001.bmp", Common::Point(270, 116), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddAnimationToPuzzle(kObject70404, 2, kPuzzle70411, "N2S04N03P03L01S01", kImageTypeBMP, Common::Point(217, 171), kDrawTypeNormal, 1000, 27, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70404, 2, 0, 70422);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddAnimationToPuzzle(kObject70404, 3, kPuzzle70411, "N2S04N03P03L01S01", kImageTypeBMP, Common::Point(217, 171), kDrawTypeNormal, 1000, 27, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70404, 3, 0, 70423);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddAnimationToPuzzle(kObject70404, 4, kPuzzle70411, "N2S04N03P03L02S01", kImageTypeBMP, Common::Point(215, 111), kDrawTypeNormal, 1000, 26, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70404, 4, 0, 70424);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddAnimationToPuzzle(kObject70404, 5, kPuzzle70411, "N2S04N03P03L02S01", kImageTypeBMP, Common::Point(215, 111), kDrawTypeNormal, 1000, 26, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject70404, 5, 0, 70425);
	_app->objectAddPresentation(kObject70404);
	_app->objectPresentationAddAnimationToPuzzle(kObject70404, 6, kPuzzle70411, "N2S04N03P03L02S02", kImageTypeBMP, Common::Point(275, 126), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAdd(kObject70406, "", "", 1);
	_app->objectAddPresentation(kObject70406);
	_app->objectPresentationAddAnimationToPuzzle(kObject70406, 0, kPuzzle70410, "N2S04N03P01S02", kImageTypeBMP, Common::Point(171, 285), kDrawTypeNormal, 1000, 13, 10.0f, 32);
	_app->objectPresentationAddAnimationToPuzzle(kObject70406, 0, kPuzzle70410, "N2S04N03P01S03", kImageTypeBMP, Common::Point(244, 268), kDrawTypeNormal, 1000, 12, 10.0f, 32);
	_app->objectPresentationAddAnimationToPuzzle(kObject70406, 0, kPuzzle70410, "N2S04N03P01S04", kImageTypeBMP, Common::Point(317, 261), kDrawTypeNormal, 1000, 7, 10.0f, 32);
	...
	for (uint32 i = 0; i < 13; i++) {
		_app->objectAddPresentation(kObject70405);
		_app->objectPresentationAddImageToPuzzle(kObject70405, i, kPuzzle70410, Common::String::format("N2S04N03P01S01.%04d.bmp", i + 1), Common::Point(107, 155), true, kDrawTypeNormal, 1000);
	}

	_app->objectAdd(kObjectCentaur, "Centaur", "N2_Centaur", 1);
	_app->objectAddBagAnimation(kObjectCentaur, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectCentaur, 0, kPuzzle70501, "N2S05N01P01L02.0001.bmp", Common::Point(278, 258), true, kDrawTypeNormal, 1000);
	_app->objectPresentationShow(kObjectCentaur);
	_app->objectAdd(kObjectDragon, "Dragon", "N2_Dragon", 1);
	_app->objectAddBagAnimation(kObjectDragon, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectDragon, 0, kPuzzle70511, "N2S05N01P02L02.0001.bmp", Common::Point(291, 263), true, kDrawTypeNormal, 1000);
	_app->objectPresentationShow(kObjectDragon);
	_app->objectAdd(kObjectPhoenix1, "Phoenix", "N2_Phoenix", 1);
	_app->objectAddBagAnimation(kObjectPhoenix1, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObjectPhoenix1, 0, kPuzzle70521, "N2S05N01P03L02.0001.bmp", Common::Point(268, 255), true, kDrawTypeNormal, 1000);
	_app->objectPresentationShow(kObjectPhoenix1);
	_app->objectAdd(kObjectChrysoberyl, "Chrysoberyl", "N2_Beryllium", 1);
	_app->objectAddBagAnimation(kObjectChrysoberyl, kImageTypeTGA, kDrawTypeAlpha, 20, 12.5f, 4);
	...
	_app->objectAddPresentation(kObject70700);
	_app->objectPresentationAddAnimationToPuzzle(kObject70700, 1, kPuzzle70600, "N2S07N01P01S01", kImageTypeBMP, Common::Point(93, 16), kDrawTypeNormal, 1000, 20, 12.5f, 4);
	_app->objectAddPresentation(kObject70700);
	_app->objectPresentationAddAnimationToPuzzle(kObject70700, 2, kPuzzle70601, "N2S07N01P01S04", kImageTypeBMP, Common::Point(286, 160), kDrawTypeNormal, 1000, 20, 12.5f, 4);
