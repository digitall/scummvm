...
#ifndef RING_PILGRIM2_ZONE_3_H
#define RING_PILGRIM2_ZONE_3_H
...
class Zone3Pilgrim2 : public EventHandlerZone {
public:
	Zone3Pilgrim2(ApplicationPilgrim2 *application);
	~Zone3Pilgrim2();
