...
#ifndef RING_PILGRIM2_ZONE_2_H
#define RING_PILGRIM2_ZONE_2_H
...
class Zone2Pilgrim2 : public EventHandlerZone {
public:
	Zone2Pilgrim2(ApplicationPilgrim2 *application);
	~Zone2Pilgrim2();
