...
#ifndef RING_PILGRIM2_ZONE_5_H
#define RING_PILGRIM2_ZONE_5_H
...
class Zone5Pilgrim2 : public EventHandlerZone {
public:
	Zone5Pilgrim2(ApplicationPilgrim2 *application);
	~Zone5Pilgrim2();
