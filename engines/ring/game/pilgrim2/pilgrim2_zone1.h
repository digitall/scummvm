...
#ifndef RING_PILGRIM2_ZONE_1_H
#define RING_PILGRIM2_ZONE_1_H
...
class Zone1Pilgrim2 : public EventHandlerZone {
public:
	Zone1Pilgrim2(ApplicationPilgrim2 *application);
	~Zone1Pilgrim2();
