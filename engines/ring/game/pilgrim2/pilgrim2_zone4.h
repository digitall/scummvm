...
#ifndef RING_PILGRIM2_ZONE_4_H
#define RING_PILGRIM2_ZONE_4_H
...
class Zone4Pilgrim2 : public EventHandlerZone {
public:
	Zone4Pilgrim2(ApplicationPilgrim2 *application);
	~Zone4Pilgrim2();
