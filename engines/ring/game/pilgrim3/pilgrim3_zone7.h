...
#ifndef RING_PILGRIM3_ZONE_7_H
#define RING_PILGRIM3_ZONE_7_H
...
class Zone7Pilgrim3 : public EventHandlerZone {
public:
	Zone7Pilgrim3(ApplicationPilgrim3 *application);
	~Zone7Pilgrim3();
