...
#ifndef RING_PILGRIM3_ZONE_10_H
#define RING_PILGRIM3_ZONE_10_H
...
class Zone10Pilgrim3 : public EventHandlerZone {
public:
	Zone10Pilgrim3(ApplicationPilgrim3 *application);
	~Zone10Pilgrim3();
