...
#ifndef RING_PILGRIM3_ZONE_9_H
#define RING_PILGRIM3_ZONE_9_H
...
class Zone9Pilgrim3 : public EventHandlerZone {
public:
	Zone9Pilgrim3(ApplicationPilgrim3 *application);
	~Zone9Pilgrim3();
