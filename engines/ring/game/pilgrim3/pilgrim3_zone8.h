...
#ifndef RING_PILGRIM3_ZONE_8_H
#define RING_PILGRIM3_ZONE_8_H
...
class Zone8Pilgrim3 : public EventHandlerZone {
public:
	Zone8Pilgrim3(ApplicationPilgrim3 *application);
	~Zone8Pilgrim3();
