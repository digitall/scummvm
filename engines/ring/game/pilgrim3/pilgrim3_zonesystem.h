...
#ifndef RING_PILGRIM3_ZONE_SYSTEM_H
#define RING_PILGRIM3_ZONE_SYSTEM_H
...
class ZoneSystemPilgrim3 : public EventHandlerZone {
public:
	ZoneSystemPilgrim3(ApplicationPilgrim3 *application);
	~ZoneSystemPilgrim3();
...
#endif // RING_PILGRIM3_ZONE_SYSTEM_H
