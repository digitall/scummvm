...
#ifndef RING_PILGRIM3_ZONE_6_H
#define RING_PILGRIM3_ZONE_6_H
...
class Zone6Pilgrim3 : public EventHandlerZone {
public:
	Zone6Pilgrim3(ApplicationPilgrim3 *application);
	~Zone6Pilgrim3();
