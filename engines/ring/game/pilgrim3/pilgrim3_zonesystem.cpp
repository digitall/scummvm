...
ZoneSystemPilgrim3::ZoneSystemPilgrim3(ApplicationPilgrim3 *application) : _app(application) {
}
...
void ZoneSystemPilgrim3::onInit() {
	error("[ZoneSystemPilgrim3::onInit()] Not implemented");
}

void ZoneSystemPilgrim3::onButtonUp(ObjectId id, Id target, Id puzzleRotationId, uint32 a4, const Common::Point &point) {
	error("[ZoneSystemPilgrim3::onButtonUp()] Not implemented");
}
