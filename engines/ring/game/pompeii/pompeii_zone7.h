...
#ifndef RING_POMPEII_ZONE_7_H
#define RING_POMPEII_ZONE_7_H
...
class Zone7Pompeii : public EventHandlerZone {
public:
	Zone7Pompeii(ApplicationPompeii *application);
	~Zone7Pompeii();
