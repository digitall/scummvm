...
#ifndef RING_POMPEII_ZONE_3_H
#define RING_POMPEII_ZONE_3_H
...
class Zone3Pompeii : public EventHandlerZone {
public:
	Zone3Pompeii(ApplicationPompeii *application);
	~Zone3Pompeii();
