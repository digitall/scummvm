...
#ifndef RING_POMPEII_ZONE_5_H
#define RING_POMPEII_ZONE_5_H
...
class Zone5Pompeii : public EventHandlerZone {
public:
	Zone5Pompeii(ApplicationPompeii *application);
	~Zone5Pompeii();
