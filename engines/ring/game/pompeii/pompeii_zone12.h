...
#ifndef RING_POMPEII_ZONE_12_H
#define RING_POMPEII_ZONE_12_H
...
class Zone12Pompeii : public EventHandlerZone {
public:
	Zone12Pompeii(ApplicationPompeii *application);
	~Zone12Pompeii();
