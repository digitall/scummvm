...
#ifndef RING_POMPEII_ZONE_1_H
#define RING_POMPEII_ZONE_1_H
...
class Zone1Pompeii : public EventHandlerZone {
public:
	Zone1Pompeii(ApplicationPompeii *application);
	~Zone1Pompeii();
