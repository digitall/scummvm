...
#ifndef RING_POMPEII_ZONE_6_H
#define RING_POMPEII_ZONE_6_H
...
class Zone6Pompeii : public EventHandlerZone {
public:
	Zone6Pompeii(ApplicationPompeii *application);
	~Zone6Pompeii();
