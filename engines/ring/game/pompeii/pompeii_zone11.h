...
#ifndef RING_POMPEII_ZONE_11_H
#define RING_POMPEII_ZONE_11_H
...
class Zone11Pompeii : public EventHandlerZone {
public:
	Zone11Pompeii(ApplicationPompeii *application);
	~Zone11Pompeii();
