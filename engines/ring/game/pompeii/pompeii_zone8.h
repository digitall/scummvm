...
#ifndef RING_POMPEII_ZONE_8_H
#define RING_POMPEII_ZONE_8_H
...
class Zone8Pompeii : public EventHandlerZone {
public:
	Zone8Pompeii(ApplicationPompeii *application);
	~Zone8Pompeii();
