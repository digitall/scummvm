...
#ifndef RING_FAUST_ZONE_SYSTEM_H
#define RING_FAUST_ZONE_SYSTEM_H
...
class ZoneSystemFaust : public EventHandlerZone {
public:
	ZoneSystemFaust(ApplicationFaust *application);
	~ZoneSystemFaust();
...
#endif // RING_FAUST_ZONE_SYSTEM_H
