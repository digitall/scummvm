...
#ifndef RING_FAUST_ZONE_4_H
#define RING_FAUST_ZONE_4_H
...
class Zone4Faust : public EventHandlerZone {
public:
	Zone4Faust(ApplicationFaust *application);
	~Zone4Faust();
