...
#ifndef RING_FAUST_ZONE_14_H
#define RING_FAUST_ZONE_14_H
...
class Zone14Faust : public EventHandlerZone {
public:
	Zone14Faust(ApplicationFaust *application);
	~Zone14Faust();
