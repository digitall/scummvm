...
#ifndef RING_FAUST_ZONE_8_H
#define RING_FAUST_ZONE_8_H
...
class Zone8Faust : public EventHandlerZone {
public:
	Zone8Faust(ApplicationFaust *application);
	~Zone8Faust();
