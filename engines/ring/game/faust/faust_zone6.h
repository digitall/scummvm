...
#ifndef RING_FAUST_ZONE_6_H
#define RING_FAUST_ZONE_6_H
...
class Zone6Faust : public EventHandlerZone {
public:
	Zone6Faust(ApplicationFaust *application);
	~Zone6Faust();
