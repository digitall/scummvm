...
void Zone8Faust::onInit() {
	...
	for (uint32 i = 0; i < 19; i++) {
		...
		_app->objectPresentationAddImageToPuzzle(kObject52212, i, kPuzzle52210, Common::String::format("a05s02n02p01s01.%04d.bmp", i + 1), Common::Point(18, 35), true, kDrawTypeNormal, 1000);
	}
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject52231, 0, kPuzzle52230, "a05s02n02p03s01", kImageTypeBMP, Common::Point(295, 293), kDrawTypeNormal, 1000, 10, 12.5f, 4);
	...
	_app->objectPresentationAddImageToPuzzle(kObject52221, 0, kPuzzle52220, "a05s02n02p02l01.bmp", Common::Point(260, 233), true, kDrawTypeNormal, 1000);
	...
	_app->objectAddPresentation(kObject53105);
	_app->objectPresentationAddImageToPuzzle(kObject53105, 0, kPuzzle53210, "a05s03n02p01l06.bmp", Common::Point(281, 16), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject53100, 0, kPuzzle53109, "a05s03n01p09l01.bmp", Common::Point(410, 166), true, kDrawTypeNormal, 1000);
	...
	_app->objectAddPresentation(kObject531022);
	_app->objectPresentationAddImageToPuzzle(kObject531022, 0, kPuzzle53110, "a05s03n01p10l01.bmp", Common::Point(122, 76), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject53111, 0, kPuzzle53101, "a05s03n01p01l01.bmp", Common::Point(290, 127), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject532111, 0, kPuzzle53210, "a05s03n02p01l01.bmp", Common::Point(167, 266), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject53211);
	_app->objectPresentationAddAnimationToPuzzle(kObject53211, 0, kPuzzle53210, "a05s03n02p01s01", kImageTypeBMP, Common::Point(167, 266), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53211, 0, 0, 53211);
	_app->objectAddPresentation(kObject53211);
	_app->objectPresentationAddAnimationToPuzzle(kObject53211, 1, kPuzzle53210, "a05s03n02p01s01", kImageTypeBMP, Common::Point(167, 266), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53211, 1, 0, 53212);
	_app->objectAddPresentation(kObject53211);
	_app->objectPresentationAddAnimationToPuzzle(kObject53211, 2, kPuzzle53210, "a05s03n02p01s01", kImageTypeBMP, Common::Point(167, 266), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53211, 2, 0, 53213);
	_app->objectAddPresentation(kObject53211);
	_app->objectPresentationAddAnimationToPuzzle(kObject53211, 3, kPuzzle53210, "a05s03n02p01s01", kImageTypeBMP, Common::Point(167, 266), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53211, 3, 0, 53214);
	_app->objectAddPresentation(kObject53211);
	_app->objectPresentationAddAnimationToPuzzle(kObject53211, 4, kPuzzle53210, "a05s03n02p01s01", kImageTypeBMP, Common::Point(167, 266), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	...
	_app->objectPresentationAddImageToPuzzle(kObject532121, 0, kPuzzle53210, "a05s03n02p01l02.bmp", Common::Point(147, 176), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532121);
	_app->objectPresentationAddImageToPuzzle(kObject532121, 1, kPuzzle53210, "a05s03n02p01l03.bmp", Common::Point(148, 175), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject53212);
	_app->objectPresentationAddAnimationToPuzzle(kObject53212, 0, kPuzzle53210, "a05s03n02p01s02", kImageTypeBMP, Common::Point(147, 176), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53212, 0, 0, 53221);
	_app->objectAddPresentation(kObject53212);
	_app->objectPresentationAddAnimationToPuzzle(kObject53212, 1, kPuzzle53210, "a05s03n02p01s02", kImageTypeBMP, Common::Point(147, 176), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53212, 1, 0, 53222);
	_app->objectAddPresentation(kObject53212);
	_app->objectPresentationAddAnimationToPuzzle(kObject53212, 2, kPuzzle53210, "a05s03n02p01s03", kImageTypeBMP, Common::Point(148, 175), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53212, 2, 0, 53223);
	_app->objectAddPresentation(kObject53212);
	_app->objectPresentationAddAnimationToPuzzle(kObject53212, 3, kPuzzle53210, "a05s03n02p01s03", kImageTypeBMP, Common::Point(148, 175), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	...
	_app->objectAddPresentation(kObject53121);
	_app->objectPresentationAddImageToPuzzle(kObject53121, 0, kPuzzle53102, "a05s03n01p02l01.bmp", Common::Point(169, 65), true, kDrawTypeNormal, 1000);
	...
	_app->objectAddPresentation(kObject53123);
	_app->objectPresentationAddImageToPuzzle(kObject53123, 1, kPuzzle53102, "a05s03n01p02l02.bmp", Common::Point(229, 352), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject53123);
	_app->objectPresentationAddAnimationToPuzzle(kObject53123, 2, kPuzzle53102, "a05s03n01p02s02", kImageTypeBMP, Common::Point(189, 216), kDrawTypeNormal, 1000, 10, 12.5f, 4);
	_app->objectAddPresentation(kObject53121);
	_app->objectPresentationAddAnimationToPuzzle(kObject53121, 1, kPuzzle53102, "a05s03n01p02s01", kImageTypeBMP, Common::Point(169, 65), kDrawTypeNormal, 1000, 22, 3.0f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject53121, 1, 0, 53121);
	_app->objectAddPresentation(kObject53124);
	_app->objectPresentationAddImageToPuzzle(kObject53124, 0, kPuzzle53102, "a05s03n01p02l03.bmp", Common::Point(166, 61), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject532125, 0, kPuzzle53210, "a05s03n02p01l04.bmp", Common::Point(0, 150), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532125);
	_app->objectPresentationAddImageToPuzzle(kObject532125, 1, kPuzzle53210, "a05s03n02p01l05.bmp", Common::Point(0, 143), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532124);
	_app->objectPresentationAddAnimationToPuzzle(kObject532124, 0, kPuzzle53210, "a05s03n02p01s04", kImageTypeBMP, Common::Point(0, 150), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject532124, 0, 0, 53225);
	_app->objectAddPresentation(kObject532124);
	_app->objectPresentationAddAnimationToPuzzle(kObject532124, 1, kPuzzle53210, "a05s03n02p01s04", kImageTypeBMP, Common::Point(0, 150), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	_app->objectPresentationSetAnimationOnPuzzle(kObject532124, 1, 0, 53226);
	_app->objectAddPresentation(kObject532124);
	_app->objectPresentationAddAnimationToPuzzle(kObject532124, 2, kPuzzle53210, "a05s03n02p01s05", kImageTypeBMP, Common::Point(0, 143), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject532124, 2, 0, 53227);
	_app->objectAddPresentation(kObject532124);
	_app->objectPresentationAddAnimationToPuzzle(kObject532124, 3, kPuzzle53210, "a05s03n02p01s05", kImageTypeBMP, Common::Point(0, 143), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	...
	_app->objectPresentationAddImageToPuzzle(kObject532201, 0, kPuzzle53220, "a05s03n02p02l01.bmp", Common::Point(117, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532202);
	_app->objectPresentationAddImageToPuzzle(kObject532202, 0, kPuzzle53220, "a05s03n02p02l02.bmp", Common::Point(214, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532203);
	_app->objectPresentationAddImageToPuzzle(kObject532203, 0, kPuzzle53220, "a05s03n02p02l03.bmp", Common::Point(299, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532204);
	_app->objectPresentationAddImageToPuzzle(kObject532204, 0, kPuzzle53220, "a05s03n02p02l04.bmp", Common::Point(396, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532205);
	_app->objectPresentationAddImageToPuzzle(kObject532205, 0, kPuzzle53220, "a05s03n02p02l05.bmp", Common::Point(118, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532206);
	_app->objectPresentationAddImageToPuzzle(kObject532206, 0, kPuzzle53220, "a05s03n02p02l06.bmp", Common::Point(214, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532207);
	_app->objectPresentationAddImageToPuzzle(kObject532207, 0, kPuzzle53220, "a05s03n02p02l07.bmp", Common::Point(303, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532208);
	_app->objectPresentationAddImageToPuzzle(kObject532208, 0, kPuzzle53220, "a05s03n02p02l08.bmp", Common::Point(396, 354), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532209);
	_app->objectPresentationAddImageToPuzzle(kObject532209, 0, kPuzzle53220, "a05s03n02p02l09.bmp", Common::Point(118, 356), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532210);
	_app->objectPresentationAddImageToPuzzle(kObject532210, 0, kPuzzle53220, "a05s03n02p02l10.bmp", Common::Point(212, 353), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532211);
	_app->objectPresentationAddImageToPuzzle(kObject532211, 0, kPuzzle53220, "a05s03n02p02l11.bmp", Common::Point(298, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532212);
	_app->objectPresentationAddImageToPuzzle(kObject532212, 0, kPuzzle53220, "a05s03n02p02l12.bmp", Common::Point(394, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532213);
	_app->objectPresentationAddImageToPuzzle(kObject532213, 0, kPuzzle53220, "a05s03n02p02l13.bmp", Common::Point(119, 355), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532214);
	_app->objectPresentationAddImageToPuzzle(kObject532214, 0, kPuzzle53220, "a05s03n02p02l14.bmp", Common::Point(211, 353), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532215);
	_app->objectPresentationAddImageToPuzzle(kObject532215, 0, kPuzzle53220, "a05s03n02p02l15.bmp", Common::Point(302, 354), true, kDrawTypeNormal, 1000);
	_app->objectAddPresentation(kObject532216);
	_app->objectPresentationAddImageToPuzzle(kObject532216, 0, kPuzzle53220, "a05s03n02p02l16.bmp", Common::Point(395, 353), true, kDrawTypeNormal, 1000);
	...
	for (uint32 i = 0; i < 50; i++) {
		...
		_app->objectPresentationAddImageToPuzzle(kObject53141, i, kPuzzle53104, Common::String::format("a05s03n01p04s01.%04d.bmp", i + 1), Common::Point(181, 82), true, kDrawTypeNormal, 1000);
	}
	...
	_app->objectPresentationAddAnimationToPuzzle(kObject54111, 0, kPuzzle54110, "a05s04n01p01s01", kImageTypeBMP, Common::Point(240, 256), kDrawTypeNormal, 1000, 10, 12.5f, 6);
	_app->objectPresentationSetAnimationOnPuzzle(kObject54111, 0, 0, 54111);
	_app->objectAddPresentation(kObject54111);
	_app->objectPresentationAddAnimationToPuzzle(kObject54111, 1, kPuzzle54110, "a05s04n01p01s01", kImageTypeBMP, Common::Point(240, 256), kDrawTypeNormal, 1000, 10, 12.5f, 10);
	...
	_app->objectPresentationAddImageToPuzzle(kObject54210, 0, kPuzzle54210, "a05s04n02p01l01.0001.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject54210);
	_app->objectPresentationAddImageToPuzzle(kObject54210, 1, kPuzzle54210, "a05s04n02p01l01.0002.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject54210);
	_app->objectPresentationAddImageToPuzzle(kObject54210, 2, kPuzzle54210, "a05s04n02p01l01.0003.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject54210);
	_app->objectPresentationAddImageToPuzzle(kObject54210, 3, kPuzzle54210, "a05s04n02p01l01.0004.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject54210);
	_app->objectPresentationAddImageToPuzzle(kObject54210, 4, kPuzzle54210, "a05s04n02p01l01.0005.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject54210);
	_app->objectPresentationAddImageToPuzzle(kObject54210, 5, kPuzzle54210, "a05s04n02p01l01.0006.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject542107);
	_app->objectPresentationAddImageToPuzzle(kObject542107, 0, kPuzzle54210, "a05s04n02p01l02.tga", Common::Point(0, 16), true, kDrawTypeAlpha, 2000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject55210, 0, kPuzzle55210, "a15s01n02p01l01.bmp", Common::Point(186, 397), true, kDrawTypeNormal, 1000);
	...
	_app->objectPresentationAddImageToPuzzle(kObject55219, 0, kPuzzle55220, "a15s01n02p02l01.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 1, kPuzzle55220, "a15s01n02p02l02.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 2, kPuzzle55220, "a15s01n02p02l03.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 3, kPuzzle55220, "a15s01n02p02l04.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 4, kPuzzle55220, "a15s01n02p02l05.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 5, kPuzzle55220, "a15s01n02p02l06.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55219);
	_app->objectPresentationAddImageToPuzzle(kObject55219, 6, kPuzzle55220, "a15s01n02p02l07.tga", Common::Point(0, 0), true, kDrawTypeAlpha, 1000);
	_app->objectAddPresentation(kObject55220);
	_app->objectPresentationAddAnimationToPuzzle(kObject55220, 0, kPuzzle55220, "a15s01n02p02s01", kImageTypeBMP, Common::Point(39, 138), kDrawTypeNormal, 2000, 10, 25.0f, 6);
