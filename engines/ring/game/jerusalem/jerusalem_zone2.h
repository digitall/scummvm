...
#ifndef RING_JERUSALEM_ZONE_2_H
#define RING_JERUSALEM_ZONE_2_H
...
class Zone2Jerusalem : public EventHandlerZone {
public:
	Zone2Jerusalem(ApplicationJerusalem *application);
	~Zone2Jerusalem();
