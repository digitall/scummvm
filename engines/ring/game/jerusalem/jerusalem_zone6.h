...
#ifndef RING_JERUSALEM_ZONE_6_H
#define RING_JERUSALEM_ZONE_6_H
...
class Zone6Jerusalem : public EventHandlerZone {
public:
	Zone6Jerusalem(ApplicationJerusalem *application);
	~Zone6Jerusalem();
