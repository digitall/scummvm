...
#ifndef RING_JERUSALEM_ZONE_9_H
#define RING_JERUSALEM_ZONE_9_H
...
class Zone9Jerusalem : public EventHandlerZone {
public:
	Zone9Jerusalem(ApplicationJerusalem *application);
	~Zone9Jerusalem();
