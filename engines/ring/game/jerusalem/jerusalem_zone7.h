...
#ifndef RING_JERUSALEM_ZONE_7_H
#define RING_JERUSALEM_ZONE_7_H
...
class Zone7Jerusalem : public EventHandlerZone {
public:
	Zone7Jerusalem(ApplicationJerusalem *application);
	~Zone7Jerusalem();
