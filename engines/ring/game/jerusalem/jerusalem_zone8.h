...
#ifndef RING_JERUSALEM_ZONE_8_H
#define RING_JERUSALEM_ZONE_8_H
...
class Zone8Jerusalem : public EventHandlerZone {
public:
	Zone8Jerusalem(ApplicationJerusalem *application);
	~Zone8Jerusalem();
