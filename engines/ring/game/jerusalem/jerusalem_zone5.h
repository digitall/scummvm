...
#ifndef RING_JERUSALEM_ZONE_5_H
#define RING_JERUSALEM_ZONE_5_H
...
class Zone5Jerusalem : public EventHandlerZone {
public:
	Zone5Jerusalem(ApplicationJerusalem *application);
	~Zone5Jerusalem();
