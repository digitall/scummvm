...
#ifndef RING_JERUSALEM_ZONE_4_H
#define RING_JERUSALEM_ZONE_4_H
...
class Zone4Jerusalem : public EventHandlerZone {
public:
	Zone4Jerusalem(ApplicationJerusalem *application);
	~Zone4Jerusalem();
