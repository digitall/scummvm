...
#ifndef RING_JERUSALEM_ZONE_10_H
#define RING_JERUSALEM_ZONE_10_H
...
class Zone10Jerusalem : public EventHandlerZone {
public:
	Zone10Jerusalem(ApplicationJerusalem *application);
	~Zone10Jerusalem();
...
#endif // RING_JERUSALEM_ZONE_10_H
