...
#ifndef RING_JERUSALEM_ZONE_1_H
#define RING_JERUSALEM_ZONE_1_H
...
class Zone1Jerusalem : public EventHandlerZone {
public:
	Zone1Jerusalem(ApplicationJerusalem *application);
	~Zone1Jerusalem();
