...
#ifndef RING_JERUSALEM_ZONE_3_H
#define RING_JERUSALEM_ZONE_3_H
...
class Zone3Jerusalem : public EventHandlerZone {
public:
	Zone3Jerusalem(ApplicationJerusalem *application);
	~Zone3Jerusalem();
