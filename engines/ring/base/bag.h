...
private:
	...
	ImageSurface  *_background;
	ImageSurface  *_image2;
	ImageSurface  *_image3;
	ImageSurface  *_image4;
	uint32         _field_48;
	uint32         _field_4C;
	uint32         _field_50;
	uint32         _field_54;
	...
	uint32         _field_60;
	uint32         _field_64;
	ImageSurface  *_image5;
	ImageSurface  *_image6;
	ImageSurface  *_image7;
	uint32         _field_74;
	uint32         _field_78;
	uint32         _field_7C;
	uint32         _field_80;
	ImageSurface  *_image8;
	uint32         _field_88;
	uint32         _field_8C;
	uint32         _field_90;
	bool           _isInitialized;
	...
	ImageSurface  *_imageErdaGun;
	ImageSurface  *_imageErdaGur;
	bool           _enabled;
	...
	void loadImage(Common::String filename, ImageSurface **image, ArchiveType archiveType) const;
