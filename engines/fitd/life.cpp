...
void getHardClip() {
	...
	//     zvCol.ZVX1 = READ_LE_int16(etageData + 0x00);
	//     zvCol.ZVX2 = READ_LE_int16(etageData + 0x02);
	//     zvCol.ZVY1 = READ_LE_int16(etageData + 0x04);
	//     zvCol.ZVY2 = READ_LE_int16(etageData + 0x06);
	//     zvCol.ZVZ1 = READ_LE_int16(etageData + 0x08);
	//     zvCol.ZVZ2 = READ_LE_int16(etageData + 0x0A);
